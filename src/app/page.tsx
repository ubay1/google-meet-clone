  ...
  return (
    <Box className=' h-screen w-full'>
      <Flex justify='center' direction='column' gap='4' align='center' height='100%'>
        ...
        <Flex justify='center' gap='4' align='center' className='flex-col w-full md:flex-row' px='4'>
          <Button
            variant='classic'
            size='3'
          ...
          <Flex justify='center' gap='4' align='center' className='flex-col w-full md:flex-row md:w-auto'>
            <TextField.Root
